<main class="android-content mdl-layout__content">
    <div class="mdl-grid">
        ...
        <div class="mdl-cell--8-col">
            <div class="page-title-card js-page-title-card mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">JS Page</h2>
                </div>
            ...
            <div class="lesson-block-card js-caesar-cipher mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">JS Caesar Cipher Developing</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p class="description">
                    ...
                    <form class="caesar-chiper-form">
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" type="text" name="message-to-encrypt">
                            <label class="mdl-textfield__label" for="sample1">enter the message</label>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" type="number" name="key-to-encrypt">
                            <label class="mdl-textfield__label" for="sample1">enter the key</label>
                        </div>
                        <button type="submit" class="mdl-button mdl-button--colored mdl-js-button mdl-button--raised mdl-js-ripple-effect">
                            Run chipher
                        </button>
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" type="text" name="encrypted-message">
                        </div>
                    </form>
            ...
            <div class="lesson-block-card js-prototype mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">JS Prototype <span class="subtitle">../main.js -> function person</span></h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p class="description">
            ...
            <div class="lesson-block-card js-type-juggling mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">JS Type Juggling <span class="subtitle"></span></h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p class="description">
            ...
            <div class="lesson-block-card js-drawing mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">JS Drawing <span class="subtitle"></span></h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p class="description">
            ...
            <div class="lesson-block-card js-simple-animation mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">JS Simple Animation <span class="subtitle"></span></h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p class="description">
                    ...
                    <button id="start_dance" onclick="walk()" class="mdl-button mdl-button--colored mdl-js-button mdl-button--raised mdl-js-ripple-effect">
                        Start Walking
                    </button>
                    <script type="text/javascript">
            ...
            <div class="lesson-block-card js-merge-sorting mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">JS Merge Sorting <span class="subtitle"></span></h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <p class="description">
